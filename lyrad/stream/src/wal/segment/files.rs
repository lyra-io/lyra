//! WAL segment namespace operations.
...
pub(in crate::wal) fn segment_path(dir: &Path, segment_number: u64) -> PathBuf {
    dir.join(format!("{segment_number:010}.{SEGMENT_EXTENSION}"))
}

pub(in crate::wal) fn list_segment_files(dir: &Path) -> Result<Vec<(u64, PathBuf)>, SegmentError> {
